...
class Bullets(Sprite):
    def __init__(self, screen, instance_settings, instance_ship):
        ...
        # 在屏幕的右上角创建子弹
        self.rect = pygame.Rect(0, 0, instance_settings.bullet_width, instance_settings.bullet_height)

        # 将子弹设置在飞船的位置，与飞船xy轴相同
        self.rect.centerx = instance_ship.rect.centerx
        self.rect.centery = instance_ship.rect.top
